...
const Reservation = () => {
    ...
    const handleReservation = async(e)=> {
        ...
        if (!isAuthenticated) {
            toast.error("Please register first to make a reservation!");
            navigate("/register");
            return;
        }
        ...
        try{
            ...
            setTime("");
            setDate("");
            navigate("/success");   //navigate to success page after filling form successfully
        }catch (error) {
       ...
       <div className="container">
         ...
         <div className="banner">
            <div className="reservation_form_box">
                ...
                <p>For futher querries, please call</p>
                <form>
                    <div>
